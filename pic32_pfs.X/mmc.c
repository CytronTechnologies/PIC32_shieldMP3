...
#define SELECT()	LATDbits.LATD9 = 0		/* CS = L */
#define	DESELECT()	LATDbits.LATD9 = 1		/* CS = H */
//#define	MMC_SEL		!LATA5		/* CS status (true:CS == L) */
...
void spi_change_baud(void){     //to max spi speed
...
//    SSPCON1bits.SSPM2=0;
//    SSPCON1bits.SSPM1=0;
//    SSPCON1bits.SSPM0=0; //12MHZ
//
//    SSPCON1bits.SSPEN=1; //enable SPI port
    
}
#define dly_100us() Delay10us(100)
...
DSTATUS disk_initialize (void)
{
	...
	DESELECT();
	for (n = 10; n>0; n--) rcv_spi();	/* 80 Dummy clocks with CS=H */      
